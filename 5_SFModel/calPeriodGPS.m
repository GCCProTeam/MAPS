function period=calPeriodGPS(broad_Para)
% Calculates the orbital period of GPS satellites based on broadcast parameters
...
for i=1:1
    ...
    for k=1:max_sat
        ...
        for j=1:size(para,1)
            ...
            para(j,5)=2*2*pi/(sqrt(GM)*para(j,3)^-3+para(j,4));%ORTM
