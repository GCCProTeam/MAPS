function RES_series=resSeriesGPS(RES)
%Function to process GPS residual data and organize it into a cell array

%INPUT: 
%RES: a matrix containing GPS residual data
